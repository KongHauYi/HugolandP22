...
import { Zap, Clock, Coins, X, Dice6, Star, TrendingUp, Package, Sparkles } from 'lucide-react';
    ...
    <div className="fixed inset-0 bg-black/80 flex items-center justify-center z-50 p-4">
      <div className="bg-gradient-to-br from-purple-900 to-indigo-900 p-4 sm:p-6 rounded-lg border border-purple-500/50 max-w-2xl w-full max-h-[80vh] overflow-y-auto">
        ...
        <div className="bg-black/30 p-4 rounded-lg border border-gray-600/50 mb-6">
          <div className="text-center">
            ...
            <p className="text-gray-300 text-sm mb-4">
              Cost: 100 coins | Duration: 24 hours (except special skills)
            </p>
        ...
        <div className="bg-black/30 p-4 rounded-lg">
          <h3 className="text-white font-bold text-lg mb-4">Available Skills</h3>
        ...
        <div className="mt-4 text-center text-xs text-gray-400">
          ...
          <p>Special skills like Treasurer and Luck Gem have shorter durations</p>
        </div>
      </div>
    </div>
  );
